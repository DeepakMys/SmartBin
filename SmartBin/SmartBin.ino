...
void loop() {
  ...
  if (distance <= 20 && distance >= 2) { // Check if the distance is lesser than 20 cm and greater than 2 cm and, if yes open the mouth of the dustbin
    lcd.print("Thanks For Keeping Our Environment Clean"); 
    servo.write(90);
    delay(3000); 
  }
  else { // Else close the mouth of the dustbin
    servo.write(0);
  }
  delay(200);
}
